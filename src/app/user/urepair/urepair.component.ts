...
@Component({
  selector: 'app-urepair',
  templateUrl: './urepair.component.html',
  styleUrls: ['./urepair.component.css']
})
export class UrepairComponent implements OnInit {
  ...
  system_dept_table() {
    ...
    $('#urepair_table').bootstrapTable({
      ...
      url: url() + '/User/getTheRepairInfoById',
      ajaxOptions: {
      },
      method: 'post',
